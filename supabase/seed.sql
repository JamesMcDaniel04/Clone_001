...
from (values
  ('Do you support SSO via SAML 2.0?', 'Yes. Clone supports single sign-on via SAML 2.0. Compatible identity providers include Okta, Azure AD, OneLogin, and Ping Identity. SSO can be enforced org-wide by administrators. (Source: SSO / SAML 2.0, last updated Apr 2026)'),
  ...
  ('Are you SOC 2 Type II certified?', 'Yes. Clone is SOC 2 Type II certified. The annual third-party audit''s most recent report covers the period ending December 2025. Reports are available under NDA upon request. (Source: SOC 2 Type II, last updated Jan 2026)'),
  ('Is your platform FedRAMP authorized?', 'No. Clone is not FedRAMP authorized and has no published roadmap to authorization. We implement controls consistent with NIST 800-53 guidance (AES-256 at rest, TLS 1.2+, MFA, RBAC, annual pen testing) but do not claim FedRAMP equivalency. [FLAG: needs legal sign-off] (Source: FedRAMP status, last updated Feb 2026)'),
  ('Are you GDPR compliant?', 'Yes. Clone is GDPR compliant and acts as a data processor. A Data Processing Agreement (DPA) is available and executed upon request. Data subject rights requests are handled within 30 days. (Source: GDPR, last updated Mar 2026)'),
  ('Are you CCPA compliant?', 'Yes. Clone complies with CCPA. Personal data is not sold. Opt-out and deletion requests are supported. (Source: CCPA, last updated Mar 2026)'),
  ...
  ('What is your uptime SLA?', 'Clone offers a 99.9% uptime SLA for production environments. Status and incident history are published on the status page. (Source: Uptime SLA, last updated Jan 2026)'),
